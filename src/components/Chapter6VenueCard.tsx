...
export const Chapter6VenueCard: React.FC = () => {
  ...
  return (
    <InView category="supporting" className="w-full max-w-3xl mx-auto px-4 py-12 relative z-20">
      <div className="glass-panel rounded-3xl p-5 sm:p-8 md:p-12 relative overflow-hidden border border-amber-200/50 shadow-xl bg-[#fffdf0]/95 backdrop-blur-md">
        ...
        {/* Core Venue Information Populating Stagger */}
        ...
        {/* Action Button Grid */}
        <InView category="functional" delay={0.38}>
