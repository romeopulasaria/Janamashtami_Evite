...
export const EventTimeline: React.FC = () => {
  return (
    <div className="w-full relative overflow-hidden py-4 text-[#0a192f] font-inter">
      ...
      {/* ------------------------------------------------------------- */}
      <InView variant="blur-fade" duration={1.0}>
        <div 
      ...
      {/* ------------------------------------------------------------- */}
      <InView variant="fade-up" duration={1.0}>
      ...
      {/* ------------------------------------------------------------- */}
      <InView variant="scale-in" duration={0.9}>
        <div 
      ...
      {/* ------------------------------------------------------------- */}
      <InView variant="blur-fade">
        <div className="bg-[#fffdf0] rounded-2xl p-8 text-center relative overflow-hidden mb-12 shadow-[0_5px_15px_rgba(0,0,0,0.05)] border border-slate-300/50">
